...
collaborative_notes: https://doimspp-my.sharepoint.com/:w:/g/personal/sformel_usgs_gov/EWt877yFmd5DvcXoDlne_9gB91y0vbgSebWutOwDsrXEOQ?e=Zavscn # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document (e.g., https://pad.carpentries.org/2015-01-01-euphoria)
...
<p id="requirements">
  ...
  {% endif %}
  They should have a few specific software packages installed (listed <a href="#setup">below</a>). You might need to work with your IT to install these, depending on your level of privileges.
</p>
